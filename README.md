...
```bash
curl -X GET "https://api.apiverve.com/v1/countrylookup?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/countrylookup](https://docs.apiverve.com/ref/countrylookup)

---

## Use Cases

Common use cases for the Country Lookup API:
